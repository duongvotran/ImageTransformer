...
sys.path.append("E:\\Study\\big_projects\\VLSP_ImageCationing\\ImageTransformer")
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='data/tmp/dataset_coco.json', help='input json file to process into hdf5')
    parser.add_argument('--dict_json', default='data/tmp/cocotalk.json', help='output json file')
    parser.add_argument('--output_pkl', default='data/tmp/coco-all', help='output pickle file')
